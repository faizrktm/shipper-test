  ...
  <CardComponent>
    <Header>
      <Text color="textMild" size="small">
        ID Driver{' '}
        <Text weight="bold" color="brand" size="small">KOB209</Text>
      </Text>
    </Header>
    <Content>
      <ProfilePicture src={Person} alt="person image" />
      <Wrapper>
        <Title color="textMild" size="small">Nama Driver</Title>
        <Text size="small">Jonathan Smith</Text>
      </Wrapper>
      <Wrapper>
        <Title color="textMild" size="small">Telepon</Title>
        <Text size="small">0822 8281 7733</Text>
      </Wrapper>
      <Wrapper>
        <Title color="textMild" size="small">Jadwal</Title>
        <Text size="small">Senin, Selasa, Rabu, Kamis, Jumat, Sabtu, Minggu</Text>
      </Wrapper>
    </Content>
  </CardComponent>
);
